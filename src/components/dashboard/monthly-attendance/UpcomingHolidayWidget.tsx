...
import { CARD_SHADOW, UPCOMING_HOLIDAY } from "./monthlyAttendanceData";

export default function UpcomingHolidayWidget() {
  return (
    <section
      className={`relative overflow-hidden rounded-xl bg-gradient-to-br from-primary-fixed to-surface-container p-6 ${CARD_SHADOW}`}
    >
      ...
      <div className="relative z-10">
        ...
        <div className="rounded-lg border border-surface-container-lowest bg-surface-container-lowest/80 p-4 shadow-sm backdrop-blur-sm">
          <div className="text-h2 font-bold text-primary">{UPCOMING_HOLIDAY.name}</div>
