      ...
      <div className="flex w-full min-h-screen flex-col lg:flex-row">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-surface-container-low relative overflow-hidden flex-col items-center justify-center p-10">
          ...
          <div className="relative z-10 mt-4 text-center max-w-md">
            <h2 className="font-h2 text-h2 text-on-surface mb-3">Reset Your Password</h2>
        ...
        <div className="w-full lg:w-1/2 flex items-top justify-center p-8 sm:p-10 bg-surface-container-lowest">
          <div className="w-full max-w-[420px] md:mt-12 mt-1">
            ...
            <div className="mb-8">
              ...
              <h1 className="font-h1 text-4xl text-on-surface mb-3">Forgot password?</h1>
              <p className="font-body-md text-body-md text-on-surface-variant">
            ...
            {!submitted ? (
              ...
              <div className="text-center p-6 bg-surface-container-low rounded-xl border border-outline-variant">
                ...
                <h3 className="font-h3 text-h3 text-on-surface mb-2">Check your email</h3>
