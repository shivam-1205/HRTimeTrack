...
export default function PricingPreview() {
   return (
    <main className="min-h-screen bg-white text-on-background antialiased py-5 pb-10">
      <div className="max-w-full mx-auto px-6 flex flex-col gap-20">
        ...
        <section className="w-full max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-10 items-end">
          <div className="bg-surface border border-outline-variant rounded-3xl p-8 flex flex-col h-[500px] shadow-sm hover:shadow-md transition-shadow duration-300">
            <div className="mb-8">
            ...
            <div className="mb-10 flex items-baseline gap-2">
              <span className="text-5xl font-bold text-on-surface">$49</span>
            ...
            <button className="w-full py-4 rounded-2xl border border-outline-variant text-on-surface font-medium hover:bg-surface-variant transition-colors cursor-pointer">
              Start Free Trial
            </button>
          </div>

          <div className="relative bg-surface/90 backdrop-blur-md border-2 border-primary rounded-3xl p-8 flex flex-col h-[540px] shadow-[0_12px_40px_-12px_rgba(53,37,205,0.25)] z-10 md:-mt-10">
            ...
            <button className="w-full py-4 rounded-2xl bg-primary text-on-primary font-medium hover:bg-primary-container transition-colors shadow-sm cursor-pointer">
              Get Started
            </button>
          </div>
                ...
                <tbody className="divide-y divide-outline-variant">
                  ...
                  <tr className="hover:bg-surface-container-lowest transition-colors">
                    ...
                    <td className="p-5 text-center text-on-surface-variant">
                      <span className=" text-outline-variant text-[20px]"><HorizontalRuleOutlinedIcon/></span>
                    </td>
